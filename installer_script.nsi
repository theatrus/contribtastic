...
!define PRODUCT_NAME "EVE-Central.com Contribtastic"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\EVE-Central.com Contribtastic.lnk" "$INSTDIR\evec_upload.exe"
  CreateShortCut "$DESKTOP\EVE-Central.com Contribtastic.lnk" "$INSTDIR\evec_upload.exe"
